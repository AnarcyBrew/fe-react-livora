                    ...
                    <div className="flex flex-wrap justify-center -mx-4">
                        <div className="w-full px-4 mb-4 md:w-2/12 md:mb-0 accordion">
                            ...
                            <ul className="invisible h-0 overflow-hidden md:h-auto md:visible">
                                <li>
                                    <Link to="/shipping" className="block py-1 hover:underline">Shipping</Link>
                                </li>
                                <li>
                                    <Link to="/refund" className="block py-1 hover:underline">Refund</Link>
                                </li>
                                <li>
                                    <Link to="/promotion" className="block py-1 hover:underline">Promotion</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="w-full px-4 mb-4 md:w-2/12 md:mb-0 accordion">
                            ...
                            <ul className="invisible h-0 overflow-hidden md:h-auto md:visible">
                                ...
                                <li>
                                    <Link to="/career" className="block py-1 hover:underline">Career</Link>
                                </li>
                                <li>
                                    <Link to="/contact" className="block py-1 hover:underline">Contact Us</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="w-full px-4 mb-4 md:w-2/12 md:mb-0 accordion">
                            ...
                            <ul className="invisible h-0 overflow-hidden md:h-auto md:visible">
                                <li>
                                    <Link to="/tnc" className="block py-1 hover:underline"
                                    >Terms & Conds</Link
                                    >
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link to="/for-dev" className="block py-1 hover:underline"
                                    >For Developer</Link
                                    >
                                </li>
                            </ul>
