            ...
            <div className="px-4 overflow-x-hidden" id="carousel">
                ...
                <div className="relative flex flex-row -mx-4">
                    ...
                    <div className="relative px-4 card group">
                        ...
                        >
                            <div
                                className="absolute flex items-center justify-center w-full h-full transition duration-200 bg-black opacity-0 group-hover:opacity-100 bg-opacity-35"
                            >
                                <div
                                    className="flex items-center justify-center w-16 h-16 text-black bg-white rounded-full"
                                >
                                    <svg
