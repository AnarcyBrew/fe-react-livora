            ...
            <div className="px-4 py-6 bg-gray-100 md:p-8 md:rounded-3xl">
                <form action="success.html">
                    ...
                    <div className="flex flex-col mb-4">
                        <label htmlFor="complete-name" className="mb-2 text-sm"
                        >Complete Name</label
                        >
                        <input
                            data-input
                    ...
                    <div className="flex flex-col mb-4">
                        <label htmlFor="email" className="mb-2 text-sm">Email Address</label>
                        <input
                            data-input
                            type="email"
                            id="email"
                    ...
                    <div className="flex flex-col mb-4">
                        <label htmlFor="address" className="mb-2 text-sm">Address</label>
                        <input
                            data-input
                            type="text"
                            id="address"
                    ...
                    <div className="flex flex-col mb-4">
                        <label htmlFor="phone-number" className="mb-2 text-sm"
                        >Phone Number</label
                        >
                        <input
                            data-input
